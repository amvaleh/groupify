...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        members.each do |member|
          ...
          if membership_type
            save_member = member.group_memberships.where(group_id: self.id).first_or_create!
            save_member.membership_type = membership_type
            save_member.save
            # group = group_memberships.where(membership_type: membership_type)
            # group.save
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
          end
